...
<head>
		...
		<![endif]-->
		<link rel="stylesheet" href="../societe/js/style.css"/>

<link rel="stylesheet" href="../societe/css/bootstrap/bootstrap.min.css"/>


<link rel="stylesheet" href="../societe/css/stylesheet.css"/>


<link rel="stylesheet" href="../societe/css/equal-height-columns.css"/>
	<link href="../societe/js/magnific-popup/magnific-popup.css"/>

<link rel="stylesheet" href="../societe/revolution/css/settings.css"/>
<link rel="stylesheet" href="../societe/revolution/css/layers.css"/>
<link rel="stylesheet" href="../societe/revolution/css/navigation.css"/>
<link rel="stylesheet" href="../societe/revolution/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css"/>


<link rel="stylesheet" href="../societe/js/owl-carousel/owl.carousel.css"/>
<link rel="stylesheet" href="../societe/js/owl-carousel/owl.theme.default.min.css"/>

<link rel="stylesheet" href="../societe/fonts/font-awesome/css/font-awesome.css"/>
<link rel="stylesheet" href="../societe/fonts/font-awesome/css/font-awesome.min.css"/>
	...
	<body>
		...
		<div class="form-group">
			<label for="exempleInputReference">Titre de rapport</label>
			<input type="text" class="form-control" name="T1" placeholder="Titre de rapport" required>
		...
		<div class="class-group">
			<label for="exemleInputName">Contenu du rapport</label>
			<textarea name="T2" id="InputMessage" class="form-control" rows="5" required placeholder="Contenu du rapport"></textarea>

 <!--placeholder=le text sera affiché en gris dans le carreau du  formulaire-->
