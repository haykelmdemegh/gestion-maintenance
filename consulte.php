...
<head>
		...
		<title>consulter les equipements</title>
		<!-- All Stylesheets -->
	...
	<body>
        ...
        <table class="table table-striped table-bordered">
         <thead>
            <tr>
               <th>Reference</th>
               <th>type_equipement </th>
               <th>detail_equipement</th> 
			    <th>date_enregistrements</th> 
		     <th>Actions</th>
            </tr>
          </thead>
          <tbody>
			...
			//crÃ©er une connexion PDO Ã  la base de donnÃ©es
              ...
              $sql = 'SELECT * FROM equipement ORDER BY  id_equipement ';
              foreach ($pdo->query($sql) as $row) {
                echo '<tr>';
                echo '<td>'. $row['Reference'] . '</td>';
                echo '<td>'. $row['type_equipement'] . '</td>';
                echo '<td>'. $row['detail_equipement'] . '</td>';  
                echo '<td>'. $row['date_enregistrements'] . '</td>';				
			echo '<td> <a class="btn btn-success" href="update.php?id_equipement =' . $row['id_equipement'] . '">Modifier</a> &nbsp&nbsp';// un boutton pour le bouton d'update
                                                                      echo '</td>';
		    echo '</tr>';
      }
            Database::disconnect();
