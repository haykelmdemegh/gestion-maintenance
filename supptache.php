			...
			<div class="inner-banner parallax-3">
				<div class="header">
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<h1><span>suppression tache </span></h1>
								<ol class="breadcrumb">
									<li><a href="index.html">Home</a></li>
									<li class="active"><a href="administration.ph^p">espace adminstratif</a></li>
        ...
        <table class="table table-striped table-bordered">
         <thead>
          ...
          <tbody>
			...
			echo '<td><a class="btn btn-danger" href="delete.php?id_tache=' . $row['id_tache'] . ' ">Delete</a>';// un autre td pour le bouton de suppression                  
                 echo '</td>';
		    echo '</tr>';
      }
            Database::disconnect();
